					...
					<div class="has-text-centered">
						<form action="${pageContext.request.contextPath}/register.do" name="form" method="post" onSubmit="return beforeSubmit(this);">
							...
							<div class="control phone">
								<input class="input" type="text" name="phone" placeholder="联系电话 （选填）">
							</div>
							<div class="control email">
								<input class="input" type="text" name="email" placeholder="电子邮件地址 （选填）">
							</div>
							<span style="color: red"><%=(request.getAttribute("register-msg")!=null)?request.getAttribute("register-msg"):""%></span>
							<div class="has-text-centered sign">
								<button type="submit" class="button register-button" tabindex="4">创建帐户</button>
							</div>
