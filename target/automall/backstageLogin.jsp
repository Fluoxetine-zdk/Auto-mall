...
<div class="container-fluid body-content">
    <div class="panel panel-default">
        <div class="panel-heading" >
            <h2 class="section-title "style="text-align: center">管理员登录</h2>
        </div>
        <form action="${pageContext.request.contextPath}/adminLogin.do" method="post" name="form" onSubmit="return beforeSubmit(this);" style="margin-bottom: 0px">
            <div class="panel-body">
                <div class="has-text-centered">
                    <div class="control username">
                        <input class="input" type="text" name="adminname" placeholder="AdminName">
                    </div>
