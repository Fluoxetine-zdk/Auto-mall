            ...
            <dl class="filter-block-brand">
                ...
                <dd class="filter-brand">
                    ...
                    <c:forEach items="${brandList}" var="brand">
                        <a href="${pageContext.request.contextPath}/loginFindCarListByBrand.do?brandid=${brand.brandid}"  class="filter-item js-filter-item <c:if test="${brand.brandid == brandid}">cur</c:if>" >${brand.brandname}</a>
                    </c:forEach>
...
<div class="wrapper_1">
    <nav aria-label="Page navigation" style="margin-left:900px">
        <ul class="pagination">
            <li>
                <a href="${pageContext.request.contextPath}/loginFindCarListByBrand.do?brandid=${brandid}&page=1&size=${pageInfo.pageSize}" aria-label="Previous">
                    <span aria-hidden="true">首页</span>
                </a>
            </li>
            <li><a href="${pageContext.request.contextPath}/loginFindCarListByBrand.do?brandid=${brandid}&page=${pageInfo.pageNum-1}&size=${pageInfo.pageSize}">&laquo;</a></li>
            <c:forEach begin="1" end="${pageInfo.pages}" var="pageNum">
                <li><a href="${pageContext.request.contextPath}/loginFindCarListByBrand.do?brandid=${brandid}page=${pageNum}&size=${pageInfo.pageSize}">${pageNum}</a></li>
            </c:forEach>

            <li><a href="${pageContext.request.contextPath}/loginFindCarListByBrand.do?brandid=${brandid}page=${pageInfo.pageNum+1}&size=${pageInfo.pageSize}">&raquo;</a></li>
            <li>
                <a href="${pageContext.request.contextPath}/loginFindCarListByBrand.do?brandid=${brandid}page=${pageInfo.pages}&size=${pageInfo.pageSize}" aria-label="Next">
