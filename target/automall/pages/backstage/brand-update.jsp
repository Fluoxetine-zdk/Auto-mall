	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<ol class="breadcrumb">
				...
				<li><a
					href="${pageContext.request.contextPath}/findBrandList.do">品牌管理</a></li>
				<li class="active">品牌添加</li>
			</ol>
			</section>
			<!-- 内容头部 /-->

			<form action="${pageContext.request.contextPath}/updateBrand.do" method="post" name="form" onSubmit="return beforeSubmit(this);">
				<!-- 正文区域 -->
				<section class="content">

				<div class="panel panel-default">
					<div class="panel-heading">品牌信息</div>
					<div class="row data-type">
						<div class="col-md-2 title">品牌编号</div>
						<div class="col-md-4 data">
							<input type="text" class="form-control" name="brandid" placeholder="品牌编号" value="${brand.brandid}" disabled>
							<input type="hidden" class="form-control" name="brandid" placeholder="品牌编号" value="${brand.brandid}">
						</div>
						<div class="col-md-2 title">品牌名称</div>
						<div class="col-md-4 data">
							<input type="text" class="form-control" name="brandname" placeholder="品牌名称" value="${brand.brandname}">
						</div>
