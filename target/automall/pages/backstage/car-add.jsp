...
<body class="hold-transition skin-blue sidebar-mini">
	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<form action="${pageContext.request.contextPath}/addCarInfo.do" method="post" name="form" onSubmit="return beforeSubmit(this);">
				<!-- 正文区域 -->
				<section class="content">
					<div class="panel panel-default">
						...
						<div class="row data-type">
							...
							<div class="col-md-4 data">
								<input type="text" class="form-control" name="carid" value="">
							</div>
							...
							<div class="col-md-4 data">
								<select class="form-control select2" style="width: 100%" name="modelid">
					...
					<span style="color: red">${addCarErrorMessage}</span>
				<!--订单信息/--> <!--工具栏-->
