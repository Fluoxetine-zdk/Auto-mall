    ...
    <div class="car-details">
        ...
        <div style="margin-top: 45px">
            <div class="car-order">
                ...
                <button class="btn-submit submit_preorder order-btn" onclick="loginFirst()">
                    加入购物车
                </button>

            </div>

<%--            <a class="consult-btn " ></a>--%>
        </div>


        <div class="form-safeguard clearfix" onclick="" style="margin-top: 30px">
            服务承诺
