...
<body class="hold-transition skin-blue sidebar-mini">
	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<form action="${pageContext.request.contextPath}/addBrand.do" method="post" name="form" onSubmit="return beforeSubmit(this);">
				<!-- 正文区域 -->
				...
				<div class="panel panel-default">
					...
					<div class="row data-type">
						...
						<div class="col-md-4 data">
							<input type="password" class="form-control" name="brandid" placeholder="品牌编号" value="">
						</div>
						<div class="col-md-2 title">品牌名称</div>
						<div class="col-md-4 data">
							<input type="text" class="form-control" name="brandname" placeholder="品牌名称" value="">
						</div>

					</div>
				</div>
				<span style="color: red">${addBrandErrorMessage}</span>
				<!--订单信息/--> <!--工具栏-->
